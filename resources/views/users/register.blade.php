                        ...
                        <div class="card-body p-md-5">
                            <div class="row justify-content-center">
                                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                    <h2 class="text-center fs-2 text-black mb-5 mx-1 mx-md-4 mt-4">Sign up</h2>
                                    <form class="mx-1 mx-md-4" method="POST" action="/users" novalidate>
                                        @csrf

                                        <div class="d-flex flex-row align-items-center mb-4">
                                            <i class="fas fa-user fa-lg me-2 mb-4 fa-fw fs-4"></i>
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            <i class="fas fa-key fa-lg me-2 mb-4 fa-fw fs-4"></i>
                                            <div class="form-outline flex-fill mb-0">
