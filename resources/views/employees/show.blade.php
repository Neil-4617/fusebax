<x-layout>
        <section class="hero-banner position-relative overflow-hidden pb-sm-0 pb-md-5">
            <div class="container">
                <div class="row d-flex flex-wrap align-items-center">
                    ...
                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12 px-5 mb-0 pb-0">
                        <div class="position-relative right-hero-color vh-75 d-flex justify-content-center mb-0 pb-0">
                            ...
                            <div class="container fusebax-idBackView fusebax-id-canvas d-none d-md-block mx-auto mt-5">
