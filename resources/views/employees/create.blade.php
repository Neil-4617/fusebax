                    ...
                    <div class="col-lg-6 mx-auto">
                        ...
                        <div class="card mb-2 fusebax-card px-3" data-step>
                            ...
                            <div class="card-body row">
                                ...
                                <hr/>
                                <h5 class="h5">Contact Person In Case Of Emergency</h5>
                                <div class="col-md-6 mb-3">
                                    <label for="contactPerson" class="form-label mb-0 ms-2">Full Name *</label>
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="contactNumber" class="form-label mb-0 ms-2">Contact Number *</label>
                                    <input 
                                    type="text" 
                                    class="form-control" 
                                    id="contactNumber" 
